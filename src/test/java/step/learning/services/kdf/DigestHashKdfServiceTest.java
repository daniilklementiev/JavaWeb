...
class DigestHashKdfServiceTest {
    ...
    void getDerivedKey() {
        ...
        String derivedKey1 = kdfService.getDerivedKey("qwerty1234", "salt");
        String derivedKey2 = kdfService.getDerivedKey("qwerty123", "salt");
        ...
        derivedKey2 = kdfService.getDerivedKey("qwerty123", "salt1");
