...
public class MixedFormParseService implements FormParseService{
    ...
    private static final int MEMORY_THRESHOLD = 10 * 1024 * 1024;  // 10MB - file in memory
    private static final int MAX_FILE_SIZE = 10 * 1024 * 1024; // 10MB - max file size
    private static final int MAX_FORM_SIZE = 20 * 1024 * 1024; // 20MB - max size for all fields in form
