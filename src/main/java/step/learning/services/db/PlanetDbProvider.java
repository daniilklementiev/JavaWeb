...
public class PlanetDbProvider implements DbProvider{
    ...
    public Connection getConnection() {
        if(connection == null){
            JsonObject dbConfig;
            try (
            Reader reader = new InputStreamReader ( Objects.requireNonNull(this.getClass().getClassLoader().getResourceAsStream( "db_config.json" ) ) )
            ) {
                ...
                throw new RuntimeException("db_config.json not found");
            }
